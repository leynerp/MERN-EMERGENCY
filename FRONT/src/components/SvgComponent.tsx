...
export const AddIcon: React.FC<SvgProps> = ({ svgH, svgW }: SvgProps) => {
  return (
    <svg viewBox='0 0 24 24' height={svgH} width={svgW} fill='none'>
...
export const UpdIcon: React.FC<SvgProps> = ({ svgH, svgW }: SvgProps) => {
  return (
    <svg viewBox='0 0 15 15' fill='none' height={svgH} width={svgW}>
      <g id='SVGRepo_bgCarrier' strokeWidth='0'></g>
      <g
        id='SVGRepo_tracerCarrier'
        strokeLinecap='round'
...
export const DelIcon: React.FC<SvgProps> = ({ svgH, svgW }: SvgProps) => {
  return (
    <svg
